    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">LAMP178 v2.0</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html"><i class="fa fa-dashboard fa-fw"></i> 后台管理系统</a>
                        </li>
                        <li>
                          ...
                          <li>
                            <a href="#"><i class="fa fa-th-list fa-fw"></i> 分类管理<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
        ...
        <div id="page-wrapper">
            @if(session('success'))
            <div id="successInfo" class="alert alert-info alert-dismissable col-sm-6 col-sm-offset-2" style="position:absolute;top:70px;">
                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                {{session('success')}}
            </div>
            @endif
             @if(session('error'))
            <div id="errorInfo" class="alert alert-danger alert-dismissable col-sm-6 col-sm-offset-2" style="position:absolute;top:70px;">
                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                {{session('error')}}
            </div>
            @endif
