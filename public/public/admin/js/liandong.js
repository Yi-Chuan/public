...
$(function () {
    //SKU信息
    // $(".div_contentlist input").bind("change", function () {
    //     step.Creat_Table();
    // });
    ...
    var step = {
        ...
        Creat_Table: function () {
            ...
            $.each(SKUObj, function (i, item){
                ...
                columnIndex++;
                arrayTile.push(SKUObj.find(".attr_name input").eq(i).val().replace("：", ""));
                var itemName = "Father_Item" + i;
                //选中的CHeckBox取值
                var order = new Array();
                $("." + itemName).find('.attr_value input').each(function (){
                    order.push($(this).val());
                    // console.log($(this).val());
                });
                
                arrayInfor.push(order);
                if(arrayInfor[arrayInfor.length-1] == ''){
                    arrayInfor.pop();
                }
            ...
            if (bCheck == true) {
                ...
                if (zuheDate.length > 0) {
                    ...
                    $.each(zuheDate, function (index, item) {
                        ...
                        // console.log(item);
                        var hin = $('<input type="hidden" name="item[]" value="'+item+'" />');
                        hin.appendTo(tr);
