...
class Uploader
{
    ...
    private function upFile()
    {
        ...
        if (!(move_uploaded_file($file["tmp_name"], $this->filePath) && file_exists($this->filePath))) { //移动失败
        	...
        	$this->imagecropper($this->filePath, $this->config['imageSimpleUploadMaxWidth'], $this->config['imageSimpleUploadMaxHeight']);  //  added by ymj 2016-02-22
	...
	public function imagecropper($source_path, $target_width, $target_height)
	{
		...
		imagejpeg($target_image,$source_path, 90);   //90表示图片的质量  added by ymj 2016-02-22
